// <copyright file="UploadResponse.cs" company="Seguridad Social API">
...
public class UploadResponse
{
    ...
    /// <summary>
    /// Gets or sets identificador del flujo para mantener la misma sesión de Oracle entre pasos
    /// IMPORTANTE: Usar este FlowId al llamar /validar-archivo o /crear-hoja.
    /// </summary>
    public string? FlowId { get; set; }

    /// <summary>
    /// Gets or sets validaciones del archivo (opcional, se incluye si se ejecutó validación automática).
    /// </summary>
